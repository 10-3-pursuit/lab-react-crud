...
function Movie() {
  ...
  // destructuring the movie state so that we can be DRY in our JSX
  const {
    // because there are two id variable, we will give this id key a new name, an alias, called movieId
    id: movieId,
    duration,
    listedIn,
    country,
